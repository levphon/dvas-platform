package io.glsx.utils;

import io.glsx.entity.ColumnEntity;
import io.glsx.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "io.glsx" : mainPath;
		...
		for(String template : templates){
			...
			try {
				...
				throw new DPException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new DPException("获取配置文件失败，", e);
		}
	}
