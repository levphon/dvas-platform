 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.glsx.vasp.admin.common.utils.wechat;
...
public class WechatUtils {
    ...
    public String GET_WX_ACODE = "https://api.weixin.qq.com/wxa/getwxacode?access_token=$ACCESS_TOKEN$";
    public String GET_WX_ACODE_UNLIMIT = "https://api.weixin.qq.com/wxa/getwxacodeunlimit?access_token=$ACCESS_TOKEN$";
    public String CREATE_WXA_QRCODE = "https://api.weixin.qq.com/cgi-bin/wxaapp/createwxaqrcode?access_token=$ACCESS_TOKEN$";
    ...
    public String getWechatToken(String appid, String secret) throws Exception {
        String tokenCacheKey = CacheConstants.WECHAT_TOKEN_KEY + appid;
        String access_token = (String) redisCacheUtils.getCacheObject(tokenCacheKey);
    ...
    private String getAndCacheWechatToken(String appid, String secret) throws Exception {
        ...
        if (StringUtils.isNotEmpty(result)) {
            ...
            if (tokenJO.containsKey("access_token")) {
                ...
                String tokenCacheKey = CacheConstants.WECHAT_TOKEN_KEY + appid;
                redisCacheUtils.setCacheObject(tokenCacheKey, access_token, expires_in, TimeUnit.SECONDS);
            }
        }
        return access_token;
    }
    ...
    public String getWechatTicket(String appid, String secret, String access_token) throws Exception {
        String ticketCacheKey = CacheConstants.WECHAT_TICKET_KEY + appid;
        String ticket = (String) redisCacheUtils.getCacheObject(ticketCacheKey);
        ...
        if (StringUtils.isEmpty(ticket)) {
            ...
            if (ticketJO.containsKey("ticket")) {
                ...
                redisCacheUtils.setCacheObject(ticketCacheKey, ticket, expires_in, TimeUnit.SECONDS);
            } else {
...
//            String resultStr = sendWeChatMsg(para, url);
...
//    }
     ...
     * @return
     */
    public static String sendWeChatMsg(String json, String url) {
     ...
     */
    public void getMiniQrCode(String sceneStr, String accessToken, String path) {
        try {
            URL url = new URL(GET_WX_ACODE_UNLIMIT.replace("$ACCESS_TOKEN$", accessToken));
...
//            paramJson.put("page", "pages/login/login");
            paramJson.put("width", Integer.valueOf(PropertiesUtils.getProperty("wechat.business.mini.width", "430")));
     ...
     */
    public void getMiniQrCode(String sceneStr, String accessToken, OutputStream out) {
        try {
            URL url = new URL(GET_WX_ACODE_UNLIMIT.replace("$ACCESS_TOKEN$", accessToken));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            httpURLConnection.setRequestMethod("POST");// 提交模式
